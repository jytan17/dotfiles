return {
  ...
  keys = {
    ...
    { '<C-Left>',  '<cmd>ZellijNavigateLeft<CR>',  desc = 'Navigate left' },
    { '<C-Down>',  '<cmd>ZellijNavigateDown<CR>',  desc = 'Navigate down' },
    { '<C-Up>',    '<cmd>ZellijNavigateUp<CR>',    desc = 'Navigate up' },
    { '<C-Right>', '<cmd>ZellijNavigateRight<CR>', desc = 'Navigate right' },
  },
  opts = {},
}
