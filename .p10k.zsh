...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      local       meta='%f'
      local      clean='%F{#a6e3a1}'    # Tokyo Night green
      local   modified='%F{#f9e2af}'    # Tokyo Night yellow
      local  untracked='%F{#cba6f7}'    # Tokyo Night magenta
      local conflicted='%F{#f38ba8}'    # Tokyo Night red
    else
      local       meta='%f'
      local      clean='%f'
      local   modified='%f'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#585b70'

  # Direnv - Tokyo Night cyan
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND='#89b4fa'
  ...
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND='#89b4fa'
  typeset -g POWERLEVEL9K_NODEENV_SHOW_NODE_VERSION=false
  typeset -g POWERLEVEL9K_NODEENV_{LEFT,RIGHT}_DELIMITER=
  typeset -g POWERLEVEL9K_NVM_FOREGROUND='#89b4fa'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND='#cdd6f4'
