...
() {
  ...
  # Frame colors - Tokyo Night dark blue
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{#565f89}╭─%f'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{#565f89}├─%f'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{#565f89}╰─%f'
  ...
  # OS Icon - Tokyo Night foreground
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#c0caf5'

  # Prompt char - Green success, Red error (Tokyo Night)
  ...
  # Directory - Tokyo Night Cyan
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#7dcfff'
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER=
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#7dcfff'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%F{#bb9af7}'    # Tokyo Night magenta
  ...
  # Node environments - Tokyo Night cyan
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND='#7dcfff'
  typeset -g POWERLEVEL9K_NODEENV_SHOW_NODE_VERSION=false
  typeset -g POWERLEVEL9K_NODEENV_{LEFT,RIGHT}_DELIMITER=
  typeset -g POWERLEVEL9K_NVM_FOREGROUND='#7dcfff'
  typeset -g POWERLEVEL9K_NVM_PROMPT_ALWAYS_SHOW=false
  typeset -g POWERLEVEL9K_NVM_SHOW_SYSTEM=true

  # Kubernetes - Tokyo Night magenta
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl'
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=('*' DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND='#bb9af7'
